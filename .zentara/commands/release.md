...
```
---
"zentara-cline": patch|minor|major
---
[list of changes]
```
...
6. If the generate_image tool is available, create a release image at `releases/[version]-release.png`
    - The image should feature a realistic-looking kangazentara doing something human-like that relates to the main highlight of the release
    - Pass `releases/template.png` as the reference image for aspect ratio and kangazentara style
