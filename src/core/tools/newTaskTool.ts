...
import { ZentaraCodeEventName, TodoItem } from "@zentara-code/types"
...
export async function newTaskTool(
	...
	try {
		...
		if (block.partial) {
			...
			cline.emit(ZentaraCodeEventName.TaskSpawned, newCline.taskId)
			...
			cline.isPaused = true
			cline.emit(ZentaraCodeEventName.TaskPaused)
