...
export const recordSourceSchema = z.enum(["read_tool", "user_edited", "zentara_edited", "file_mentioned"])
...
export const fileMetadataEntrySchema = z.object({
	...
	zentara_read_date: z.number().nullable(),
	zentara_edit_date: z.number().nullable(),
