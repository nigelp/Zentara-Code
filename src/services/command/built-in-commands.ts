...
<initialization>
  ...
  <todo_list_creation>
    ...
    1. Check for existing AGENTS.md files
       ...
       - .zentara/rules-code/AGENTS.md (relative to project root)
       - .zentara/rules-debug/AGENTS.md (relative to project root)
       - .zentara/rules-ask/AGENTS.md (relative to project root)
       - .zentara/rules-architect/AGENTS.md (relative to project root)
       ...
       - .cursorrules, CLAUDE.md, .zentararules
    ...
    8. Compile/Update AGENTS.md files
       ...
       - Create mode-specific files in .zentara/rules-*/ directories (IN PROJECT ROOT)
...
<analysis_workflow>
  ...
  1. **Discovery Phase**:
     ...
     IMPORTANT: The .zentara folder should be created in the PROJECT ROOT, not system root!
...
<output_structure>
  ...
  <mode_specific_files>
    ...
    - .zentara/rules-code/AGENTS.md (create .zentara in project root, not system root!)
    - .zentara/rules-debug/AGENTS.md (relative to project root)
    - .zentara/rules-ask/AGENTS.md (relative to project root)
    - .zentara/rules-architect/AGENTS.md (relative to project root)
    
    IMPORTANT: The .zentara directory must be created in the current project/workspace root directory,
    ...
    ├── .zentara/                        # IN PROJECT ROOT, NOT SYSTEM ROOT!
    │   ├── rules-code/
    ...
    .zentara/rules-code/AGENTS.md - ONLY non-obvious coding rules discovered by reading files:
    ...
    .zentara/rules-debug/AGENTS.md - ONLY non-obvious debugging discoveries:
    ...
    .zentara/rules-ask/AGENTS.md - ONLY non-obvious documentation context:
    ...
    .zentara/rules-architect/AGENTS.md - ONLY non-obvious architectural constraints:
