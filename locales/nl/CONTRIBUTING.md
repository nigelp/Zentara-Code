...
### 3. Word lid van de Zentara Code-community

- **Hoofdmethode:** Word lid van onze [Discord](https://discord.gg/zentaracode) en stuur een DM naar **Hannes Rudolph (`hrudolph`)**.
- **Alternatief:** Ervaren bijdragers kunnen direct meedoen via [GitHub Projects](https://github.com/orgs/ZentaraCodeInc/projects/1).
...
- **Bestaande issues controleren:** Zoek in [GitHub Issues](https://github.com/ZentaraCodeInc/Zentara-Code/issues).
...
- Bekijk het [GitHub Project](https://github.com/orgs/ZentaraCodeInc/projects/1) voor niet-toegewezen "Good First Issues".
- Voor documentatie, bezoek [Zentara Code Docs](https://github.com/ZentaraCodeInc/Zentara-Code-Docs).

### Bugs of problemen melden

- Controleer eerst of er al meldingen zijn.
- Maak nieuwe bugmeldingen met de ["Bug Report"-template](https://github.com/ZentaraCodeInc/Zentara-Code/issues/new/choose).
- **Beveiligingsproblemen:** Meld privé via [security advisories](https://github.com/ZentaraCodeInc/Zentara-Code/security/advisories/new).
...
```
git clone https://github.com/JOUW_GEBRUIKERSNAAM/Zentara-Code.git
```
...
Door een pull request in te dienen, ga je ermee akkoord dat je bijdragen worden gelicenseerd onder de Apache 2.0-licentie, in overeenstemming met de licentie van Zentara Code.
