...
# Đóng góp cho Zentara Code

Zentara Code là một dự án do cộng đồng dẫn dắt và chúng mình rất trân trọng mọi đóng góp. Để đơn giản hóa quy trình hợp tác, chúng mình áp dụng cách tiếp cận [Issue-First](#cách-tiếp-cận-issue-first), nghĩa là tất cả [Pull Request (PR)](#gửi-pull-request) phải được liên kết với một GitHub Issue trước. Vui lòng đọc kỹ hướng dẫn này.
...
### 3. Tham gia cộng đồng Zentara Code

- **Cách chính:** Tham gia [Discord](https://discord.gg/zentaracode) của chúng mình và nhắn tin trực tiếp cho **Hannes Rudolph (`hrudolph`)**.
- **Cách thay thế:** Cộng tác viên có kinh nghiệm có thể tham gia trực tiếp qua [GitHub Projects](https://github.com/orgs/ZentaraCodeInc/projects/1).
...
- **Kiểm tra issue hiện có:** Tìm kiếm trong [GitHub Issues](https://github.com/ZentaraCodeInc/Zentara-Code/issues).
...
- Xem [Dự án GitHub](https://github.com/orgs/ZentaraCodeInc/projects/1) để tìm "Good First Issues" chưa được gán.
- Về tài liệu, hãy xem [Zentara Code Docs](https://github.com/ZentaraCodeInc/Zentara-Code-Docs).

### Báo cáo lỗi

- Kiểm tra báo cáo hiện có trước.
- Tạo báo cáo lỗi mới bằng [mẫu "Bug Report"](https://github.com/ZentaraCodeInc/Zentara-Code/issues/new/choose).
- **Lỗ hổng bảo mật:** Báo cáo riêng qua [security advisories](https://github.com/ZentaraCodeInc/Zentara-Code/security/advisories/new).
...
```
git clone https://github.com/TEN_TAI_KHOAN/Zentara-Code.git
```
...
Khi gửi pull request, bạn đồng ý rằng đóng góp của mình sẽ được cấp phép theo Giấy phép Apache 2.0, phù hợp với giấy phép của Zentara Code.
