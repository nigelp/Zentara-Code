...
### 3. Zentara Code Topluluğuna Katıl

- **Ana yöntem:** [Discord](https://discord.gg/zentaracode)'umuza katıl ve **Hannes Rudolph (`hrudolph`)**'a DM gönder.
- **Alternatif:** Deneyimli katkı sağlayanlar [GitHub Projects](https://github.com/orgs/ZentaraCodeInc/projects/1) üzerinden doğrudan katılabilir.
...
- **Mevcut issue'ları kontrol et:** [GitHub Issues](https://github.com/ZentaraCodeInc/Zentara-Code/issues)'da ara.
...
- [GitHub Projesi](https://github.com/orgs/ZentaraCodeInc/projects/1)'nde atanmamış "Good First Issues" bak.
- Dokümantasyon için [Zentara Code Docs](https://github.com/ZentaraCodeInc/Zentara-Code-Docs)'u ziyaret et.

### Hata veya Sorun Bildirme

- Önce mevcut raporları kontrol et.
- ["Bug Report" şablonu](https://github.com/ZentaraCodeInc/Zentara-Code/issues/new/choose) kullanarak yeni hata raporları oluştur.
- **Güvenlik açıkları:** [security advisories](https://github.com/ZentaraCodeInc/Zentara-Code/security/advisories/new) aracılığıyla özel olarak bildir.
...
```
git clone https://github.com/KULLANICI_ADIN/Zentara-Code.git
```
...
Pull request göndererek, katkılarının Zentara Code'un lisanslamasıyla tutarlı olarak Apache 2.0 Lisansı altında lisanslanacağını kabul etmiş olursun.
