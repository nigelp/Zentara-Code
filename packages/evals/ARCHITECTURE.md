...
- **Environment Setup**: Launches VS Code with Zentara extension in isolated container
...
- **Development Tools**: VS Code with language-specific extensions and Zentara Code extension
