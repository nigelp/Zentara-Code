...
export const DEFAULT_MODES: readonly ModeConfig[] = [
	{
		...
		groups: ["read", ["edit", { fileRegex: "\\.md$", description: "Markdown files only" }], "browser", "mcp" , "lsp"],
		customInstructions:
	...
	},
	{
		...
		groups: ["read", "edit", "browser", "command", "mcp", "lsp"],
	},
	{
		slug: "ask",
		name: "❓ Ask",
	...
	},
	{
		...
		groups: ["read", "edit", "browser", "command", "mcp", "debug", "lsp"],
		customInstructions:
