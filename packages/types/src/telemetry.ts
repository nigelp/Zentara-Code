...
/**
 * ZentaraCodeTelemetryEvent
 */

export const zentaraCodeTelemetryEventSchema = z.discriminatedUnion("type", [
	z.object({
		type: z.enum([
...
export type ZentaraCodeTelemetryEvent = z.infer<typeof zentaraCodeTelemetryEventSchema>
